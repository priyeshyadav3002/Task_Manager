...
const Team = () => {
  ...
  return (
    /* Changed bg-slate-950 to a bright, warm off-white Human Pattern background */
    <div className="min-h-screen bg-[#FDFCFB] flex font-sans text-slate-900">
      <Sidebar isExpanded={isExpanded} setIsExpanded={setIsExpanded} />
      
      {/* Main content with dynamic margin and ink-black typography */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {members.map((member, i) => (
            <motion.div
              ...
              /* Changed bg-slate-900 to Pure White organic cards with soft rose shadows */
            ...
            >
              <div className="flex justify-between items-start mb-8">
                {/* Avatar: Rose palette for Admin, Teal for Member */}
                ...
                {/* Badge: Organic styling with warm borders */}
              ...
              <div className="pt-8 border-t border-slate-50 flex items-center justify-between">
                ...
                {/* Task Count: Strong emphasis with slate typography */}
